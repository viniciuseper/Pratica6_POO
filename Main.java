...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Funcionario func;
        Empresa emp1;
        String nome,email,telefone,departamento,dtEntrada,RG, nomeEmp,CNPJ;
        double salario;
        int qtdeFunc;
        boolean status=true;
        ...
        for (int i=0;i<2;i++) {
            ...
            dtEntrada=JOptionPane.showInputDialog("dataEntrada");
            RG=JOptionPane.showInputDialog("RG");
            salario=Double.parseDouble(JOptionPane.showInputDialog("Salario"));
            func = new Funcionario(nome,email,telefone,departamento,dtEntrada,RG,salario, status);
            funcionarios[i]=func;
        }
